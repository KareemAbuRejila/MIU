...
const NewPost = (props) => {
    ...
    const [isChangedTitleVal, setIsChangedTitleVal] = useState(false);
    ...
    return (
        <div className="NewPost">
            ...
            <input ref={titleVal} onChange={() => {setIsChangedTitleVal(true);}} type="text" label={'i'} name={'i'} />

            <button onClick={() => {
                if (isChangedTitleVal) {
                    console.log(titleVal.current.value)
                    setIsChangedTitleVal(false);
